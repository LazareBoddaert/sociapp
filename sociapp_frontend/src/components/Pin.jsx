  ...
  return (
    <div className="m-2">
      <div
        ...
        className="relative cursor-zoom-in w-auto hover:shadow-lg rouded-lg hoverflow-hidden transition-all duration-500 ease-in-out"
      >
            ...
            <div className="flex items-center justify-between">
              <div className='flex gap-2'>
                <a
                  ...
                  className="bg-white w-9 h-9 rounded-full flex items-center justify-center text-darck text-xl opacity-75 hover:opacity-100 hover:shadow-md outline-none"
                >
